--- 
title: "Programação em R para biotecnologistas"
...
<summary> Prompt </summary>
  ...
  + Tarefa: Elabore um gráfico de médias para comparar o pH de um produto sujeito a quatro tratamentos (dosagens) </p>
      
  + Contexto: os dados são referentes a um experimento inteiramente aleatorizado com quatro doses e três replicações, cuja finalidade foi observar o efeito da dosagem de essência de limão no pH final de um produto lácteo;  </p>
    
  + Detalhamento: Faça um gráfico de médias, com barras representando as margens de erro. Use cores diferentes e apresente as letras comparativas do teste. Crie rótulos intuitivos para os eixos. As letras do teste (grupos) devem aparecer acima das colunas que representam cada tratamento. </p>
    
  + Ferramentas: Linguagem R e pacote ggplot2 ; </p>
    
  + Dados: A margem de erro para as médias é de 0.187. A tabela do teste de Tukey é apresentada a seguir: </p>

<table>
        <caption>Tukey's Test</caption>
        <thead>
            <tr>
                <th>Groups</th>
                <th>Treatments</th>
...
Aleatorize um experimento com três tratamentos (T1, T2 e T3) e cinco réplicas considerando um planejamento inteiramente casualizado.  
...
<div class="code-block">
```{r message=FALSE, warning=FALSE}
# Carregando a biblioteca agricolae
library(agricolae)

# Definir número de replicações e tratamentos
rep <- 5
tratamentos <- c("T1", "T2", "T3")

# Criar o design experimental completamente aleatorizado
design <- design.crd(tratamentos, r = rep, seed = 42)
```
...
```{r}
# Visualizar o plano experimental
print(design$book)
```
...
Aleatorize um experimento com três tratamentos (T1, T2 e T3) e seis réplicas considerando um delineamento casualizado em blocos.  
...
# Criar o design experimental completamente aleatorizado
design <- design.rcbd(tratamentos, r = rep)
```
...
# Determinação de crescimento microbiano
...
_E. coli_ foi utilizada para produzir o hormônio do crescimento porcino recombinante. A bactéria cresce aerobicamente em batelada, com glicose como substrato limitante do crescimento. As concentrações de células e de substrato foram medidas em função do tempo de cultivo, com os resultados ao lado. 

_Fonte: Bioprocess Engineering Principles, Pauline Doran, 2nd Edition_ 


<table border="1" cellpadding="5" cellspacing="0">
    <caption>Tabela 1 - Concentração de células em função do tempo.</caption>
    <thead>
        <tr>
            <th>Tempo (h)</th>
            <th style="text-align:center;">Concentração de células, x (kg/m³)</th>
        </tr>
    </thead>
    <tbody>
        <tr><td>0</td><td style="text-align:center;">0.2</td></tr>
        <tr><td>0.33</td><td style="text-align:center;">0.21</td></tr>
        <tr><td>0.5</td><td style="text-align:center;">0.22</td></tr>
        <tr><td>0.75</td><td style="text-align:center;">0.32</td></tr>
        <tr><td>1</td><td style="text-align:center;">0.47</td></tr>
        <tr><td>1.5</td><td style="text-align:center;">1</td></tr>
        <tr><td>2</td><td style="text-align:center;">2.1</td></tr>
        <tr><td>2.5</td><td style="text-align:center;">4.42</td></tr>
        <tr><td>2.8</td><td style="text-align:center;">6.9</td></tr>
        <tr><td>3</td><td style="text-align:center;">9.4</td></tr>
        <tr><td>3.1</td><td style="text-align:center;">10.9</td></tr>
        <tr><td>3.2</td><td style="text-align:center;">11.6</td></tr>
        <tr><td>3.5</td><td style="text-align:center;">11.7</td></tr>
        <tr><td>3.7</td><td style="text-align:center;">11.6</td></tr>
        </tbody>
</table>
...
<details>
<summary> Resposta - com todos os dados </summary>
<div class="chat-container">
<div class="code-block">
...
# Estimativas de mu por diferenças finitas de primeira ordem
...
<details>
<summary> Resposta - dados filtrados </summary>
<div class="chat-container">
<div class="code-block">
```{r}
#Dados experimentais da biomassa em função do tempo
...
Use a inteligência artifical para linearizar os dados e calcular o $\mu_{max}$. 
